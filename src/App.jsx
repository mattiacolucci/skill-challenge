        ...
        <Container>
          ...
          <div className='!flex-1 w-screen flex flex-row justify-evenly py-5 gap-6'>
            ...
            <div className='h-auto basis-[15%] flex flex-col items-center py-3 border-r-2 border-white border-opacity-60 text-white px-4 gap-2'>
              ...
              <Link to="/giveItAtry" className='w-full h-[30px] rounded-md text-left hover:bg-white hover:bg-opacity-40 transition-all duration-300 px-4 leading-[30px] text-ellipsis overflow-hidden whitespace-nowrap'>
                GIVE IT A TRY!
              </Link>
            </div>
